...
procedure TfrmRepEventos.ReporteValidStock;
{Genera el reporte de validación de stock.}
var
  f: Integer;
  reg: regEven;
  p, q, d: SizeInt;
...
begin
  GroupBox1.Visible := (ComboBox1.ItemIndex = 1);
end;
...
begin
  ...
  griRegistros.AgrEncabTxt('DESCRIPCIÓN' , 350);
  ...
  ComboBox1.AddItem('Validac. de Stock', nil);
