...
interface
uses
  Classes, SysUtils, Types, fgl, synaser, MisUtils;
type
...
*******************************
  ...
  public
    ...
    property puerto: string read Fpuerto;  //nombre puerto serial: "COM1", "COM2", ...
    function puertoN: string;    //Puerto como número: "1", "2", ...
    procedure Conectar;
...
function TNiloConexion.puertoN: string;
begin
...
constructor TNiloConexion.Create(puerto0: string);
begin
