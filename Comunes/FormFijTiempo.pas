...
type
  ...
  TfrmFijTiempo = class(TForm)
    ...
    procedure Mostrar(cab: TObjGrafCabina);
    procedure MostrarIni(cab: TObjGrafCabina);
  private
    ogCab: TObjGrafCabina;      //referecnia a objeto
...
procedure TfrmFijTiempo.Mostrar(cab: TObjGrafCabina);
...
procedure TfrmFijTiempo.MostrarIni(cab: TObjGrafCabina);
